...
print("Knowledge folder expected at:", knowledge_directory)
print("Database folder expected at:", db_directory)
...
# Text files - fixed with explicit UTF-8 encoding to avoid UnicodeDecodeError
