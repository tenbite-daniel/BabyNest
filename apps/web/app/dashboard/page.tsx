    ...
    useEffect(() => {
        ...
        (async () => {
            try {
                ...
                setProfile(p);
                if (typeof p?.weeksPregnant === "number")
                    setWeek(p.weeksPregnant);
            } catch (e) {
                console.error(e);
            }
        })();
        ...
        <div className="min-h-screen bg-[--color-background]">
            <div className="max-w-6xl mx-auto px-4 py-6">
                ...
                <section className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-5 flex flex-col items-center text-center">
                        ...
                        <button
                            ...
                            onClick={() =>
                                alert(
                                    "You can link this to a detailed weekly tips page."
                                )
                            }
                        >
                            Details
                ...
                <section className="mt-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-5 border border-[--color-secondary]/20 flex sm:flex-col justify-center items center gap-4">
                        <div>
                            <h4>Due date's near! Chaty's</h4>
                            <h4>here to get you ready</h4>
                            <p className="text-sm text-gray-600">
                                Almost time to meet your little one! Let's take
                                a look at what you'll need for the big day and
                                how you can make these last moments calm and
                                special.
                            </p>
                            <button
                                onClick={() => router.push("/chatbot")}
                                className="px-4 py-2 rounded-lg text-white text-sm mt-5"
                ...
                <section className="mt-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-5">
                        <div className="flex flex-wrap gap-2">
                            {Object.keys(profile?.symptoms ?? {}).length ===
                                0 && (
                                <span className="text-sm text-gray-500">
                                    No symptoms noted yet.
                                </span>
                            )}
                            {Object.values(profile?.symptoms ?? {}).map((s) => (
                                <SymptomTag
                                    key={s}
                                    label={s}
